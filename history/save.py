...
class Model(object):
    ...
    def _initialize(self):
        ...
        o = n - 10
        for _ in xrange(120):
            a = random.randint(-o, o)  # 山丘的 x 位置
            b = random.randint(-o, o)  # 山丘的 z 位置
            c = -1  # 山丘的基地
            h = random.randint(1, 6)  # 山丘的高度
            s = random.randint(4, 8)  # 2 * s 是山丘的边长
            d = 1  # 山丘如何快速变薄
